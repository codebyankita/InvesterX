...
const ContactUs: React.FC = () => {
    ...
    const handleFileEvent = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            if (file.size > 10 * 1024 * 1024) {
                ...
                // setFileSuccessMessage("File uploaded successfully!");
            }
        }
    };
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (uploadedFile) {
            data.append("pitchDeck", uploadedFile);  // Ensure the pitchDeck file is appended here
        }
    ...
    return (
        <div className="flex bg-[#f6f8ff] items-center min-h-screen justify-center">
            <div className="w-full h-full md:max-w-lg p-8 bg-white rounded-3xl">
                ...
                {fileSuccessMessage && <p className="text-green-600 text-sm">{fileSuccessMessage}</p>}
                <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <input
                            id="file-upload"
                            type="file"
                            accept="application/pdf, application/msword, application/vnd.ms-powerpoint, application/vnd.openxmlformats-officedocument.presentationml.presentation, text/plain"
...
//             }
//             setUploadedFile(file);
//             setFileSuccessMessage("File selected successfully!");
//         }
//     };
...
//         } else {
//             data.append("pitchDeck", "null"); // Explicitly indicate no file
//         }
...
// //             data.append("pitchDeck", uploadedFile);
// //         } else {
// //             data.append("pitchDeck", "");  // Send empty string to indicate no file
// //         }
